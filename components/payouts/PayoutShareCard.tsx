    ...
    <div className="mb-8">
      ...
      <div className="flex justify-center gap-3 mt-4">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-gray-800 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-700 transition-colors border border-gray-700"
        >
          {copied ? (
            <>
